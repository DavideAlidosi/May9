...
class MainWindow(QtWidgets.QMainWindow, mainWindow.Ui_MainWindow):
	def __init__(self, parent=mayaMainWindow()):
		...
		self.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Context Connector " + version, None, QtGui.QApplication.UnicodeUTF8))
	...
	def updateMacrossButtons(self):
		...
		for m in macrosses:
			...
			btn.setSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Maximum)
	...
	def buttonMenu(self, btn, data):
		...
		newMacross_action = QtGui.QAction(self)
	...
	def macrossMenu(self, btn):
		...
		connections_menu = QtGui.QMenu(self)
		connections_menu.setTitle("Connection")		

		
		# main menu actions
		rename_action = QtGui.QAction(self)
