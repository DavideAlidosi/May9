all_commands = {
    ...
    "Boolean Union": "mel.eval('polyCBoolOp -op 1 -ch 1 -preserveColor 0 -classification 2')",
    "Boolean Difference": "mel.eval('polyCBoolOp -op 2 -ch 1 -preserveColor 0 -classification 2')",
    "Boolean Intersection": "mel.eval('polyCBoolOp -op 3 -ch 1 -preserveColor 0 -classification 2')",
